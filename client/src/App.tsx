            ...
            <div key={s} className="flex items-center">
              ...
              >
                <span className="flex items-center justify-center font-bold" style={{
                  width: '24px',
                  height: '24px',
                  backgroundColor: step === s ? 'rgba(255,255,255,0.2)' : 'rgba(255,255,255,0.05)',
                  borderRadius: '50%',
                  fontSize: '11px',
                  border: step === s ? '1px solid rgba(255,255,255,0.4)' : '1px solid rgba(255,255,255,0.1)'
                }}>
                  {i + 1}
                </span>
                <span style={{
              ...
              {i < 3 && (
                <div className="mx-1 opacity-20" style={{ width: '20px', height: '1px', backgroundColor: 'var(--text-secondary)', marginRight: '20px' }} />
              )}
            </div>
          ))}
        </div>
